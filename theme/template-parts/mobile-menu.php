...
<!-- Mobile Menu (includes header + items in one container) -->
<nav id="mobile-menu" class="lg:hidden fixed top-0 left-0 right-0 bottom-0 bg-white z-50 -translate-y-full transition-transform duration-500 ease-out overflow-y-auto">
    <!-- Menu Header (slides with the menu) -->
    <div class="h-16 border-b border-black flex items-center bg-white sticky top-0 z-10">
        <div class="wrapper-nopad w-full">
            <div class="page-grid items-center">
                ...
                <div class="col-span-8 px-4">
                    <h2 class="text-xs uppercase font-metro">Menu</h2>
                </div>
                <!-- Close Button -->
