...
<section class="wrapper py-12 pt-44">
    <div class="flex gap-x-[var(--grid-gutter)]">
        
        <!-- LEFT VERTICAL STRIP - Sticky sidebar -->
        <aside class="hidden lg:block flex-shrink-0" style="width: calc((100% - (var(--grid-gutter) * 11)) / 12);">
        ...
        <div class="flex-1">
            <div class="grid grid-cols-12 gap-y-28 gap-x-[var(--grid-gutter)]">
